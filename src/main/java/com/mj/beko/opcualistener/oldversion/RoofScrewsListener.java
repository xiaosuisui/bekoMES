 ...
 */
@Component
public class RoofScrewsListener implements MonitoredDataItemListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(RoofScrewsListener.class);
