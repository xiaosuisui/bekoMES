 ...
 */
@Component
public class Repair2ArriveAndLeftListener implements MonitoredDataItemListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(Repair2ArriveAndLeftListener.class);
    ...
    public void onDataChange(MonitoredDataItem monitoredDataItem, DataValue oldValue, DataValue newValue) {
        ...
        //异步推送当前工单和下一工单到三段返修工位
        asynPushDataToScreen.pushCurrentAndNextOrder(currentOrder, nextOrder, "Repair02");
    }
}